...
final class ManageFoldersDataSource: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: k_MoveToFolderTableViewCellIdentifier) as? MoveToFolderTableViewCell else {
        ...
        cell.setupMoveToFolderTableCell(checked: false, iconColor: color!, title: folderName!, showCheckBox: false)
